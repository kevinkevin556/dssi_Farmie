...
df_mean <- read.csv("data/scallion_weather_chiayi.csv")
...
#coeff_union <- Reduce(union, list(coeff1, coeff2))
```
...
get_mse(pre, test_data$price)
get_mse(pre_naive, test_data$price)
```